...
import umpaz.brewinandchewin.common.block.entity.LargeKegFootprintBlockEntity;
...
public class BnCBlockEntityTypes {
    ...
    public static final BlockEntityType<LargeKegFootprintBlockEntity> LARGE_KEG_FOOTPRINT = BrewinAndChewin.getHelper().createBlockEntityType(LargeKegFootprintBlockEntity::new, BnCBlocks.LARGE_KEG_FOOTPRINT);
    ...
    public static void registerAll() {
        ...
        Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, BrewinAndChewin.asResource("large_keg_footprint"), LARGE_KEG_FOOTPRINT);
