...
public class BnCTextureModifiers {
    private static final Map<Identifier, MapCodec<? extends TextureModifier>> FACTORIES = new HashMap<>();
    private static final Map<MapCodec<? extends TextureModifier>, Identifier> FACTORIES_TO_KEY = new HashMap<>();

    public static final Codec<? extends TextureModifier> CODEC =  Identifier.CODEC.comapFlatMap(key -> {
    ...
    public static void register(Identifier id, MapCodec<? extends TextureModifier> codec) {
